...
export class ResponsiveActivation {
  ...
  get activatedInput(): any {
    let key: string = this.activatedInputKey;
   ...
   */
  public hasKeyValue(key: any): any {
    let value: any = this._options.inputKeys[key];
   ...
   * in the HTML markup
   */
  private _buildRegistryMap(): BreakPoint[] {
   ...
   */
  private _keyInUse(key: any): boolean {
